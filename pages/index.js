...
import ticketbg from '../public/ticketbg.png'
        ...
        <div ref={ref}>
          <div className={styles.ticket}>
            ...
            <div className={styles.ticket_profile}>
              <Image src={session? session.user.image : profile} width={100} height={100} />
              <h3>{session? session.user.name : "Your Name"}</h3>
            </div>
            <div className={styles.ticket_date}>
              <p style={{fontSize:"12px"}}>October 3, 2021
                <br />
      4pm Online</p>
            </div>
      
            <div className={styles.ticket_host}>
              <p style={{fontSize:"10px"}}>Hosted by
                <br />
      ...
      return (
        <div className={styles.container}>
          ...
          <main className={styles.main}>
            ...
            <p className={styles.event_name}>Techcast episode 3 Hacktoberfest special</p>
